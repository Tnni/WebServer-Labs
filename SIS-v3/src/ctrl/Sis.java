...
public class Sis extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("report") == null && request.getParameter("gxml") == null
				&& request.getParameter("json") == null && request.getParameter("ajax") == null) {
			...
			try {
				...
				while (iterator.hasNext()) {
					...
					result += "<tr><td>" + ((StudentBean) entry.getValue()).getSid() + "</td><td>"
							+ ((StudentBean) entry.getValue()).getName() + "</td><td>"
							+ ((StudentBean) entry.getValue()).getCredit_taken() + "</td><td>"
							+ ((StudentBean) entry.getValue()).getCredit_graduate() + "</td></tr>";
				}
